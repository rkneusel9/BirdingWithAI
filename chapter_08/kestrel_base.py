#
#  file:  kestrel_base.py
#
#  Train the base kestrel model
#
#  RTK, 15-Dec-2024
...
if (len(sys.argv) == 1):
    print()
    print("kestrel_base <mb> <epochs> <outdir>")
    print()
...
#  Load the data
num_classes = 2
xtrn = np.load("data/kestrel_xtrain.npy")/255
ytrn = np.load("data/kestrel_ytrain.npy")
...
#  Configure and train
model = LeNet((64,64,3), num_classes)
