#
#  file:  train_bird6_augment.py
#
#  Train bird6 models including augmentation
#
#  RTK, 30-Sep-2024
...
if (len(sys.argv) == 1):
    print()
    print("train_bird6_augment <mname> rgb|gray 64|32 <minibatch> <epochs> <factor> <outdir>")
    print()
    ...
    print("  <factor>    - number of times to augment training images")
