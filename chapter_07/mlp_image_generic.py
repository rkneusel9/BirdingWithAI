#
#  file:  mlp_image_generic.py
#
#  Use MLP trained on NA birds embeddings to classify an image
#
#  RTK, 01-Dec-2024
...
if (len(sys.argv) == 1):
    print()
    print("mlp_image_generic <mlp> <top-n> <image>")
    print()
    print("  <mlp>   - trained MLP model name (.pkl)")
...
#  Predict the class label and associated "probability"
prob = clf.predict_proba(image_features).squeeze()
